...
namespace Sparcpoint.Tests.Controllers
{
    public partial class ProductsControllerTests
    {
        class FakeProductRepo : IProductRepository
        {
            ...
            public Task<System.Collections.Generic.IEnumerable<ProductResponseDto>> SearchAsync(string name, System.Collections.Generic.Dictionary<string, string> metadata = null, System.Collections.Generic.List<string> categories = null)
            {
                return Task.FromResult((System.Collections.Generic.IEnumerable<ProductResponseDto>)new System.Collections.Generic.List<ProductResponseDto>());
            }
        }
