...
{
    // EVAL: Database context class to manage all the operations against the database and to keep track of all the entities.
    public partial class SparcpointInventoryDatabaseContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            if (!optionsBuilder.IsConfigured)
            {
                ...
                optionsBuilder.UseSqlServer("Server=.\\SQLEXPRESS;Database=Sparcpoint.Inventory.Database;Trusted_Connection=True;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Category>(entity =>
            {
                entity.HasKey(e => e.InstanceId)
                    .HasName("PK__Categori__5C51994FE3BA7841");
            ...
            modelBuilder.Entity<InventoryTransaction>(entity =>
            {
                entity.HasKey(e => e.TransactionId)
                    .HasName("PK__Inventor__55433A6B914F46B2");
            ...
            {
                entity.HasKey(e => e.InstanceId)
                    .HasName("PK__Products__5C51994FA3123AF0");
