...
namespace Interview.Web.Controllers
{
    ...
    {
        private readonly IInventoryTransactionsRepository _inventoryRepo;
        private readonly IProductRepository _productRepo;

        public ProductController(IInventoryTransactionsRepository inventoryRepo, IProductRepository productRepo)
        {
        ...
        public Task AddInventory(InventoryTransactions inventoryTransactions)
        {
